...
class DeBERTa(pl.LightningModule):
    def __init__(
        ...
        self.model: DebertaV2Model = DebertaV2Model.from_pretrained(pretrained_model_name_or_path, return_dict=True)
    ...
    def forward(
        ...
        return dict(pooled_output=pooled_dropout.unsqueeze(1), attentions=outputs.attentions)
