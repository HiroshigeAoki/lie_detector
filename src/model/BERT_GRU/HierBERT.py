...
class HierBERT(AbstractHierModel):
    ...
    def build_wordattennet(self, *args, **kwargs):
        self.wordattennet = BERT(use_attention=self.hparams.use_attention, *args, **kwargs)
    ...
    def forward(self, input_ids, attention_mask, pad_sent_num, labels=None, indices=None):
        ...
        sentattennet_outputs = self.sentattennet(self.fc(self.dropout(word_pooled_outputs)), lengths)
